        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    &nbsp;
                    <a href= <?php echo base_url("index.php/dosen/delete_dosen/$dsn->id") ?> onclick="return hapusDosen('Anda yakin ingin menghapus Dosen yang bernama <?php echo $dsn->nama ?>?')">
