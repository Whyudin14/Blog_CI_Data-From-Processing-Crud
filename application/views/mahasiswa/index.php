        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    &nbsp;
                    <a href= <?php echo base_url("index.php/mahasiswa/delete/$mhs->id") ?> onclick="return hapusMahasiswa('Anda yakin ingin menghapus mahasiswa yang bernama <?php echo $mhs->nama ?>?')">
